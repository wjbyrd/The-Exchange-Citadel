...
window.questionBanks = {
  ...
  "hard": [
    ...
    {
      "id": 210,
      "q": "Refer to the image above. Why does the right-panel AD slope downward?",
      "options": [
    ...
    {
      "q": "If P rises, which Mundell-Fleming AD chain is correct?",
      "options": [
    ...
    {
      "q": "If P falls, which Mundell-Fleming AD chain is correct?",
      "options": [
        "M/P rises, LM* shifts right, e falls, NX rises, and Y rises",
        "M/P falls, LM* shifts left, e rises, NX falls, and Y falls",
    ...
    {
      "q": "Y=4,000, C=2,450, I=850, and G=650. What is NX?",
      "options": [
        "50",
        "-50",
        "700",
    ...
    {
      "q": "A country keeps a fixed exchange rate and monetary independence. What must be limited?",
      "options": [
        "free capital mobility",
        "fiscal policy",
        "exports",
    ...
    {
      "q": "A country keeps a fixed exchange rate and free capital mobility. What must be surrendered?",
      "options": [
        "independent monetary policy",
        "fiscal policy",
        "imports",
  ...
  "elite": [
    ...
    {
      "id": 306,
      "q": "Refer to the image above. Moving from A to C in the AD derivation corresponds to...",
      "options": [
    ...
    {
      "id": 310,
      "q": "S = 1,250, I = 1,480. Then a fiscal consolidation raises saving by 150. What is the new NX?",
      "options": [
        "-80",
        "-230",
        "80",
    ...
    {
      "q": "In Chapter 6, a tariff appreciates the real exchange rate. In floating-rate Mundell-Fleming, a tariff also appreciates the exchange rate. What is the shared lesson?",
      "options": [
    ...
    {
      "q": "Why does floating-rate fiscal policy fail to raise income strongly in Mundell-Fleming?",
      "options": [
    ...
    {
      "q": "Refer to the image above. Why does moving from B to A not prove NX rises?",
      "options": [
    ...
    {
      "q": "Why is the open-economy AD curve downward sloping in Mundell-Fleming?",
      "options": [
  ...
  "legendary": [
    ...
    {
      "id": 9008,
      "q": "Refer to the image above. The left panel explains the right-panel AD curve because...",
      "options": [
    ...
    {
      "q": "A fiscal expansion in a small open economy lowers NX in Chapter 6, but fiscal expansion under floating rates leaves Y largely unchanged in Mundell-Fleming. What links the two results?",
      "options": [
    ...
    {
      "q": "A tariff under Chapter 6 and a tariff under floating-rate Mundell-Fleming both disappoint protectionist expectations. Why?",
      "options": [
    ...
    {
      "q": "A price-level decline in Mundell-Fleming raises Y along AD. What is the mechanism?",
      "options": [
    ...
    {
      "q": "In the image above, starting at Y3 above LRAS, what long-run pressure should follow?",
      "options": [
    ...
    {
      "q": "In the image above, starting at Y1 below LRAS, what long-run pressure should follow?",
      "options": [
  ...
  "finalBoss": [
    ...
    {
      "id": 4004,
      "q": "Refer to the image above. Fiscal expansion is best represented by...",
      "options": [
        "E to A",
        "E to I",
        "B to C",
    ...
    {
      "id": 4007,
      "q": "Refer to the image above. The tariff movement from B to A mainly shows...",
      "options": [
    ...
    {
      "id": 4013,
      "q": "Refer to the image above. Which side keeps monetary independence and free capital mobility?",
      "options": [
        "side 2",
        "side 1",
        "side 3",
    ...
    {
      "id": 4016,
      "q": "Refer to the image above. AD connects different price levels to...",
      "options": [
  ...
  "legendaryBoss": [
    ...
    {
      "id": 9104,
      "q": "Refer to the image above. A tariff moves the economy from B to A. What stays fixed?",
      "options": [
        "S - I",
        "R",
        "NX(R)",
    ...
    {
      "id": 9107,
      "q": "Refer to the image above. Movement from B to A means...",
      "options": [
    ...
    {
      "id": 9110,
      "q": "Refer to the image above. Movement from B to C means...",
      "options": [
    ...
    {
      "id": 9113,
      "q": "Refer to the image above. Which two goals are preserved on side 1?",
      "options": [
        "fixed exchange rate and independent monetary policy",
    ...
    {
      "id": 9116,
      "q": "Refer to the image above. P1, P2, and P3 map to...",
      "options": [
    ...
    {
      "id": 9125,
      "q": "S = 2,000 and I = 2,260. What is NX?",
      "options": [
        "-260",
        "260",
        "4260",
    ...
    {
      "id": 9126,
      "q": "Y = 5,000, C = 3,100, I = 1,100, G = 950. What is NX?",
      "options": [
        "-150",
        "150",
        "850",
...
window.microSkillRepairPools = {
  ...
  "mundell_fleming_assumptions": [
    {
      "q": "For Mundell-Fleming assumptions, what should be the first move?",
      "options": [
    ...
    {
      "q": "Which mistake most often breaks Mundell-Fleming assumptions?",
      "options": [
        "reversing the first model link",
        "checking the relevant identity",
        "following the exchange-rate channel",
    ...
    {
      "q": "Which clue tells you this is a Mundell-Fleming assumptions question?",
      "options": [
  ...
  "derive_ad_from_mf": [
    {
      "q": "For AD from Mundell-Fleming, what should be the first move?",
      "options": [
    ...
    {
      "q": "Which mistake most often breaks AD from Mundell-Fleming?",
      "options": [
        "reversing the first model link",
        "checking the relevant identity",
        "following the exchange-rate channel",
    ...
    {
      "q": "Which clue tells you this is a AD from Mundell-Fleming question?",
      "options": [
  ...
  "open_economy_ad_slope": [
    {
      "q": "For open-economy AD slope, what should be the first move?",
      "options": [
    ...
    {
      "q": "Which mistake most often breaks open-economy AD slope?",
      "options": [
        "reversing the first model link",
        "checking the relevant identity",
        "following the exchange-rate channel",
    ...
    {
      "q": "Which clue tells you this is a open-economy AD slope question?",
      "options": [
...
window.microSkillBridgePools = {
  ...
  "mundell_fleming_assumptions": [
    {
      "q": "After you identify Mundell-Fleming assumptions, what is the next step?",
      "options": [
        "trace the next variable in the chain",
        "stop after naming the concept",
        "assume NX always rises",
    ...
    {
      "q": "Which answer form is strongest for Mundell-Fleming assumptions?",
      "options": [
        "direction plus mechanism",
        "direction only",
        "a definition with no application",
    ...
    {
      "q": "If two answers sound possible for Mundell-Fleming assumptions, what should you compare?",
      "options": [
        "the model assumption and the first shifted curve or identity",
        "which option has the flashiest wording",
        "whether the answer mentions a boss",
  ...
  "derive_ad_from_mf": [
    {
      "q": "After you identify AD from Mundell-Fleming, what is the next step?",
      "options": [
        "trace the next variable in the chain",
        "stop after naming the concept",
        "assume NX always rises",
    ...
    {
      "q": "Which answer form is strongest for AD from Mundell-Fleming?",
      "options": [
        "direction plus mechanism",
        "direction only",
        "a definition with no application",
    ...
    {
      "q": "If two answers sound possible for AD from Mundell-Fleming, what should you compare?",
      "options": [
        "the model assumption and the first shifted curve or identity",
        "which option has the flashiest wording",
        "whether the answer mentions a boss",
  ...
  "open_economy_ad_slope": [
    {
      "q": "After you identify open-economy AD slope, what is the next step?",
      "options": [
        "trace the next variable in the chain",
        "stop after naming the concept",
        "assume NX always rises",
    ...
    {
      "q": "Which answer form is strongest for open-economy AD slope?",
      "options": [
        "direction plus mechanism",
        "direction only",
        "a definition with no application",
    ...
    {
      "q": "If two answers sound possible for open-economy AD slope, what should you compare?",
      "options": [
        "the model assumption and the first shifted curve or identity",
        "which option has the flashiest wording",
        "whether the answer mentions a boss",
...
function getNXFromSavingInvestmentCalc(){
  ...
  const nx = S - I;
  return makeECGeneratedQuestion(81000 + ecRand(1,999), `National saving is ${S} and domestic investment is ${I}. What is NX?`, String(nx), [String(-nx), String(S+I), String(Math.abs(nx)+75)], "saving_investment_capital_flows", "calculation", "LO6.2", "calculate_nx_from_s_i", `NX = S - I = ${S} - ${I} = ${nx}.`, "Use S - I = NX.");
}
function getNXFromSpendingCalc(){
  ...
  const Y = C + I + G + NX;
  return makeECGeneratedQuestion(82000 + ecRand(1,999), `Y=${Y}, C=${C}, I=${I}, and G=${G}. What is NX?`, String(NX), [String(-NX), String(Y-C), String(C+I+G)], "accounting_identities", "calculation", "LO6.2", "calculate_nx_from_y_c_i_g", `NX = Y - C - I - G = ${NX}.`, "Rearrange Y = C + I + G + NX.");
}
...
function getFiscalSavingShiftCalc(){
  ...
  return makeECGeneratedQuestion(85000 + ecRand(1,999), `S=${S}, I=${I}, and policy changes saving by ${dS}. What is the new NX?`, String(newNX), [String(S-I), String(-(newNX)), String(newNX+dS)], "fiscal_policy_open_economy", "calculation", "LO6.5", "trace_domestic_fiscal_expansion", `New saving is ${S+dS}. NX = ${S+dS} - ${I} = ${newNX}. Saving ${direction}, so the trade balance moves with S - I.`, "Update saving first, then use S - I.");
}
